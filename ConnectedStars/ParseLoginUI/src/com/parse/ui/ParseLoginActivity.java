...
public class ParseLoginActivity extends FragmentActivity implements
        ...
        ParseOnLoginSuccessListener, ParseOnLoadingListener, ParseLoginFragment.httpResponseListner, httpParseResponse {
    ...
    public static final String role = "ProfileRole";
    public static final String token = "ProfileAccessToken";
...
//    }
    ...
    public void callback() {
        if (progressDialog != null) {
            progressDialog.dismiss();
            ParseLoginActivity.this.runOnUiThread(new Runnable() {

                @Override
                public void run() {
                    Toast.makeText(ParseLoginActivity.this, "Log in Success", Toast.LENGTH_SHORT).show();
                    loggedIn = true;
                    ...
                    //editor.
                    //prefs = PreferenceManager.getDefaultSharedPreferences(ParseLoginActivity.this);
                    //prefs.edit().putBoolean("Islogin", loggedIn).commit(); // islogin is a boolean value of your login status;
                    Intent myTriggerActivityIntent = new Intent(ParseLoginActivity.this, jobQuery.class);
